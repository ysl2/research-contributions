...
# The data_dir is configured to be never used.
parser.add_argument('--data_dir', default='/dataset/dataset0/', type=str, help='dataset directory')
# The json_list is replaced by meta_data2.yaml
...
parser.add_argument('--trainset_cache_num', default=24, type=int, help='number of cached data in trainset')
parser.add_argument('--valset_cache_num', default=6, type=int, help='number of cached data in valset')
parser.add_argument('--testset_cache_num', default=6, type=int, help='number of cached data in testset')
...
def main_worker(args: argparse.ArgumentParser) -> None:
    ...
    if args.model_name is not None and args.model_name != 'unetr':
        raise ValueError(f'Unsupported model {str(args.model_name)}')
